...
App = (function() {
  function App(inputor, container) {
    this.currentFlag = null;
    this.controllers = {};
    this.aliasMaps = {};
    this.$inputor = $(inputor);
    this.setupRootElement(false, false, container);
    this.listen();
  }

  App.prototype.createContainer = function(doc, container) {
    var ref;
    if ((ref = this.$el) != null) {
      ref.remove();
    }
    ...
    if (container) {
      return $(container).append(this.$el = $("<div class='atwho-container'></div>"));
    } else {
      return $(doc.body).append(this.$el = $("<div class='atwho-container'></div>"));
    }
  };

  App.prototype.setupRootElement = function(iframe, asRoot, container) {
    var error;
    if (asRoot == null) {
      asRoot = false;
    }
    ...
    return this.createContainer((this.iframeAsRoot = asRoot) ? this.document : document, container);
  };
...
$.fn.atwho = function(method) {
  ...
  this.filter('textarea, input, [contenteditable=""], [contenteditable=true]').each(function() {
    ...
    if (!(app = ($this = $(this)).data("atwho"))) {
      $this.data('atwho', (app = new App(this, method.container)));
    }
